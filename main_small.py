...
from utils_ce import get_dataset, get_network, get_eval_pool, ParamDiffAug, train_synset
...
def main(args):
    ...
    ###
    # channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, testloader, loader_train_dict, class_map, class_map_inv = get_dataset(
    #     args.dataset, args.data_path,args.test_data_path, args.batch_train, args.res, args=args)
